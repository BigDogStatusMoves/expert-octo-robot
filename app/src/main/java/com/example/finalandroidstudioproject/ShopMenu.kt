package com.example.finalandroidstudioproject
...
import com.example.finalandroidstudioproject.listview.ItemAdapter
import com.example.finalandroidstudioproject.listview.ItemModel
...
class ShopMenu : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listView.adapter = ItemAdapter(this, R.layout.item_layout, itemList)
